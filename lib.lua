...
-- Add this to your library (after the sections table)
function sections:playerlist(props)
    ...
    local function createPlayerButton(playerName)
        ...
        button.MouseButton1Click:Connect(function()
            ...
            -- Select new
            button.BackgroundColor3 = self.library.theme.accent
    ...
    local function refreshPlayerList()
        ...
        for _, player in pairs(game.Players:GetPlayers()) do
            if player ~= game.Players.LocalPlayer then -- Optional: exclude local player
                local btn = createPlayerButton(player.Name)
